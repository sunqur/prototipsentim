...
using Programers.Data.Concrete;
...
using Programers.Services.Concrete;

namespace Programers.Services.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection LoadMyServices(this IServiceCollection serviceCollection, string connectionString)
        {
            serviceCollection.AddDbContext<ProgramersContext>(options => options.UseSqlServer(connectionString));
            ...
            }).AddEntityFrameworkStores<ProgramersContext>();
