                            ...
                            if (commentResult.Data) {
                                ...
                                $.each(commentResult.Data.Comments.$values,
                                    function (index, comment) {
                                        ...
                                        let newProduct = getJsonNetObject(newComment.Product, newComment);
                                        if (newProduct !== null) {
                                            productsArray.push(newProduct);
                                        }
                                        if (newProduct === null) {
                                            newProduct = productsArray.find((product) => {
                                                return product.$id === newComment.Product.$ref;
                                            });
                                        }
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            dataTable.row(tableRow).data([
                                ...
                                commentUpdateAjaxModel.CommentDto.Comment.Product.Title,
                        ...
                        success: function (data) {
                            ...
                            if (commentResult.Data) {
                                dataTable.row(tableRow).data([
                                    ...
                                    commentResult.Data.Comment.Product.Title,
